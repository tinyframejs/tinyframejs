...
export default {
  ...
  "baseUrl": "/",
  "organizationName": "tinyframejs",
  "projectName": "tinyframejs",
  "onBrokenLinks": "warn",
    ...
    [
      "classic",
      {
        "docs": {
          ...
          "editUrl": "https://github.com/tinyframejs/tinyframejs/edit/main/"
        },
        "blog": false,
        "theme": {
  ...
  "themeConfig": {
    ...
    "footer": {
      ...
      "copyright": "Copyright 2025 AlphaQuantJS. Built with Docusaurus."
    },
    "prism": {
      "theme": {
        "plain": {
